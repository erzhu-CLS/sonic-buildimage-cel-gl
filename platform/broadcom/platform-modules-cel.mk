...
CLS_DS4150_PLATFORM_MODULE_VERSION = 1.0
...
export CLS_DS4150_PLATFORM_MODULE_VERSION
...
CLS_DS4150_PLATFORM_MODULE = platform-modules-ds4150_$(CLS_DS4150_PLATFORM_MODULE_VERSION)_amd64.deb
$(CLS_DS4150_PLATFORM_MODULE)_PLATFORM = x86_64-cls_ds4150-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CLS_DS4150_PLATFORM_MODULE)))
